    ...
    theme: {
        ...
        extend: {
            ...
            utopiaSpace: {
                ...
                /* One-up pairs */
                'fluid-3xs-2xs': 'var(--space-3xs-2xs)',
                'fluid-2xs-xs': 'var(--space-2xs-xs)',
                'fluid-xs-s': 'var(--space-xs-s)',
                'fluid-s-m': 'var(--space-s-m)',
                'fluid-m-l': 'var(--space-m-l)',
                'fluid-l-xl': 'var(--space-l-xl)',
                'fluid-xl-2xl': 'var(--space-xl-2xl)',
                'fluid-2xl-3xl': 'var(--space-2xl-3xl)',
                'fluid-3xl-4xl': 'var(--space-3xl-4xl)',
                /* Custom pairs */
                'fluid-s-l': 'var(--space-s-l)',
                'fluid-m-s': 'var(--space-m-s)',
                'fluid-s-xs': 'var(--space-s-xs)',
                'fluid-header': 'var(--headerheight)',
                /* Custom */
                'fluid-splashoverlap': 'var(--splash-overlap)',
                'fluid-containertramline': 'var(--container-tramline)',
            },
            fontSize: (theme) => ({
                ...theme('utopiaStep'),
                ...theme('utopiaSpace'),

...
import HeroImage from '~/components/Images/HeroImage.astro';
import BlockPicture from '~/components/Images/BlockPicture.astro';
import { Icon } from 'astro-icon/components';


<PageLayout hero={frontmatter.hero} title={frontmatter.title} description={frontmatter.description} isHeroDark={frontmatter.hero.dark}>
  <Hero slot="slothero" hero={frontmatter.hero} >
...
<Skills skillset={frontmatter.skillset} bg='bg-page' >
## Skills
</Skills>

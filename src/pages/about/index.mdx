...
<PageLayout hero={frontmatter.hero} title={frontmatter.title} description={frontmatter.description} isHeroDark={frontmatter.hero.dark}>
  <Hero slot="slothero" hero={frontmatter.hero} >
      ...
      <div class="relative flex justify-center" >
        ...
        <div class="h-full w-full" x-bind:class="shown ? 'animate-stretch' : 'invisible'">
            <Picture
              src={imgProfile__hd}
              widths={[300, 640, 800]}
              sizes={'(max-width: 48em) calc(100vw - 2rem), 50vw'}
    ...
    <Fragment slot="background">
      <HeroPicture src={bg_teal} class="object-cover object-bottom md:object-center w-full h-full" alt="Rustic Teal background" />
    </Fragment>
  </Hero>

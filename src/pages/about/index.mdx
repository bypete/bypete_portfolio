...
<PageLayout hero={frontmatter.hero} title={frontmatter.title} description={frontmatter.description} isHeroDark={frontmatter.hero.dark}>
  <Hero slot="slothero" hero={frontmatter.hero} >
    <Fragment slot="content">
        <h1 class="relative  text-shadow-headline text-fl-step-5">
            {frontmatter.title}
        </h1>
        <div class="rte">
            <p class="font-light text-fl-step-1">I'm a Surrey based Front-End developer with over two decades of experience in digital.</p>

...
<Skills skillset={frontmatter.skillset} bg='bg-white' >
## Skills I know
</Skills>
...
<Figure x-data="{compare: true}" grid={['flex flex-col md:flex-row items-center bg-gray-50 gap-8', utilities.tramline.all]} caption='Snapshot of a typical listing index. Clients, developers, and third-party agencies have access to the most recent version of any page.' wrapper="my-4 md:my-8">
  <Image src={listing_index} alt="Devices view" class="w-full h-auto shadow-md border border-gray-200 hover:cursor-pointer" />
</Figure>

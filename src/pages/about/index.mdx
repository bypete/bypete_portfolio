...
<PageLayout  {...frontmatter}  og={{
  ...
  <p class="text-step-1 font-semibold" data-animate='turnIn'>I'm Pete, a UX/UI Designer and front-end developer with over ten years’ experience creating thoughtful, accessible, and mobile-first digital experiences. </p>
    <p data-animate='turnIn'>I specialise in design systems, performance-focused development, and building interfaces that make life easier for users.</p>
...
<Banner mode={'page'} shadow={true} aspect="min-h-[40cqw]" class="my-fluid-2xl" />

...
<BlockPicture src={gyl_logo} wrapper="my-fluid-l [&+*]:mt-fluid-l" alt="GamesYouLoved Logo" breakout={false} credit={frontmatter.title} class="w-full h-auto max-w-1/2 mx-auto my-fluid-m" widths={[400, 720]} />
...
<BlockPicture src={block__sw_40} wrapper="my-fluid-l [&+*]:mt-fluid-l" alt="Exhibition event" credit='GamesYouLoved' />

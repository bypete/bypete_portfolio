...
og:
  ...
  image: 
    ...
    originalSrc: 'assets/work/kalixa/og__image.jpg'
    alt: 'Kalixa'
brand: 
  bg: 'bg-[#2b93dd]'
  color: 'text-[#2b93dd]'
...
<p class="text-step-2/snug font-medium ">Kalixa Pay was marketed as a cost-effective contactless prepaid Mastercard with exclusive travel benefits. The site had to sell the product to potential customers, deliver relevant content to existing customers, and give access to accounts in a secure PCI environment.</p>

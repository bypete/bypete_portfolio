...
og:
  ...
  image: 
    ...
    originalSrc: 'assets/work/elekta/product_1x1_ipad_landscape.png'
    alt: 'Elekta'
brand: 
  bg: 'bg-[#747474]'
  color: 'text-[#747474]'
...
product:
  src: '~/assets/work/elekta/product_1x1_ipad_landscape.png'
...
<p class="text-step-2/snug font-medium ">Elekta is a forward-thinking Swedish healthcare company that provides precision radiation therapy solutions. They asked Fifth Dimension to improve their current intranet solution, Elekta.biz.</p>

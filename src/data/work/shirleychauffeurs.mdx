...
<p class="text-step-1">[Shirley Chauffeurs](https://shirleychauffeurs.co.uk/) is a family-run business known for its exceptional service and meticulous attention to detail. The business takes great pride in ensuring its role in the customer's special day is as perfect as possible.</p>
...
<div class="angleclip-tl-fluid-l px-safe-inline lg:angleclip-tl-fluid-2xl -mb-fluid-5xl pb-fluid-5xl col-[full] bg-radial-[at_50%_75%] from-slate-700 to-slate-950 to-90% pt-fluid-2xl lg:pt-fluid-3xl text-center not-rte">
  <div class="max-w-[100ch] mx-auto ">
  <Icon name="mdi:lighthouse" class="h-fluid-2xl w-fluid-2xl text-content-light mx-auto rounded-full bg-slate-700/80 p-fluid-xs mb-fluid-s" />
  <p class="font-headline text-step-2 md:text-step-4/tight font-normal text-content-light ">Site optimisation was a key focus during development, and the effort has produced some <strong class="font-extrabold">excellent</strong> Lighthouse results</p>
  </div>
</div>
...
<BlockPicture src={basket_40} wrapper="my-fluid-l" alt="Close up of Wedding couple" credit={frontmatter.title}  />

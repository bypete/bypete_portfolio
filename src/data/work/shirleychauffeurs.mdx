...
<p class="text-fl-step-1">[Shirley Chauffeurs](https://shirleychauffeurs.co.uk/) is an independent family business that required an online presence to complement their exemplary professional service. The business took great pride in their attention to detail, ensuring their role in the customer's special day was as perfect as possible.</p>

As a first point of contact, the site needed to complement their professional standards and instill trust in the company's capabilities. 
...
## Learning points
This was a freelance project that I delivered independently. It was a good introduction to Netlify's automated deploys and built on my knowledge of Astro. 

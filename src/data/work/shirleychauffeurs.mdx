...
<div class="angleclip-tl-fluid-l lg:angleclip-tl-fluid-2xl -mb-fluid-5xl pb-fluid-5xl breakout bg-radial-[at_50%_75%] from-slate-700 to-slate-950 to-90% pt-fluid-2xl lg:pt-fluid-3xl text-center not-rte">
...
<BlockPicture src={basket_40} wrapper="my-fluid-2xl" alt="Close up of K Ring and cyclist" credit={frontmatter.title}  />

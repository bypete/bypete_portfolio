...
og:
  ...
  image: 
    ...
    originalSrc: 'assets/work/onepay/product_1x1_ipad_portrait_phone.png'
    alt: 'OnePay'
brand: 
  bg: 'bg-[#00a3e2]'
  color: 'text-[#00a3e2]'
...
product:
  src: '~/assets/work/onepay/product_1x1_ipad_portrait_phone.png'
...
<p class="text-step-2/snug font-medium ">OnePay are one of the UK’s leading providers of alternative payment solutions for temporary employees who can’t open a UK bank account. Their service provides businesses and their workers a fast, easy, and efficient way to pay and receive wage payments.</p>

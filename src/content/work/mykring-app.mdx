...
<Figure caption='Unnecessary elements from the online responsive version (left) were stripped out to streamline the app layout (middle and right) ' credit='App v1.0.1, K&nbsp;Wearables Ltd.'>

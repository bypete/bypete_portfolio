...
import splitscreen_manage from './mykringapp/app1.1__managecards.jpg'
...
<Block
  ...
  >
    ...
    >
        <p class="mb-fl-space-xs text-fl-step-2/snug font-headline">
        ...
        <p class="cite inline-flex items-center"><span class="mr-fl-space-2xs text-fl-step--1 text-gold leading-none "><span class="inline-block w-6 h-6 icon-[mdi--star]"></span><span class="inline-block w-6 h-6 icon-[mdi--star]"></span><span class="inline-block w-6 h-6 icon-[mdi--star]"></span><span class="inline-block w-6 h-6 icon-[mdi--star]"></span><span class="inline-block w-6 h-6 icon-[mdi--star]"></span></span>James, 26 November 2021 Play store</p>
    </blockquote>
  </div>
...
<p>
  <a href="https://apps.apple.com/gb/app/mykring/id1578688520?see-all=reviews"
     class="link"
     target="_blank"><span class="text-fl-step-3 font-black">4.6</span></a> out of 5 <span class="text-fl-step--1">(Sept &rsquo;22)</span>
</p>

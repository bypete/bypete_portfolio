...
<Block
    ...
    wrapperClass="bg-amber-400 not-prose my-fl-space-2xl"
    class="py-fl-space-3xl justify-center text-center relative"
...
>
    ...
    <p slot="s1" class="text-fl-step-7/tight font-black"><Icon name="lucide:message-circle-heart" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="youtube" />20K <span class="text-fl-step--1 block font-medium">Users</span></p>
    <p slot="s2" class="text-fl-step-7/tight font-black"><Icon name="lucide:message-square-text"  class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="instagram" />19 <span class="text-fl-step--1 block font-medium">Message boards</span></p>
    <p slot="s3" class="text-fl-step-7/tight font-black"><Icon name="lucide:messages-square" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="x-twitter" />3.2K <span class="text-fl-step--1 block font-medium">Topics</span></p>
</Block>

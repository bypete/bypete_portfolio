...
<div class="relative grid grid-cols-1 md:grid-cols-3 py-16 md:py-32 xl:py-48 gap-8 content-center max-w-container mx-auto">
  <p class="text-center leading-snug"><span class="block text-fl-step-6 text-[#24a7be] font-black"><Icon name="lucide:message-circle-heart" class="w-12 h-12 mx-auto block" title="Users" />20K</span> Users</p>
  <p class="text-center leading-snug"><span class="block text-fl-step-6 text-[#24a7be] font-black"><Icon name="lucide:message-square-text" class="w-12 h-12 mx-auto block" title="Message boards" />19</span> Message boards</p>
  <p class="text-center leading-snug"><span class="block text-fl-step-6 text-[#24a7be] font-black"><Icon name="lucide:messages-square" class="w-12 h-12 mx-auto block" title="Topics" />3.2K</span> Topics</p>
</div>
</Block>

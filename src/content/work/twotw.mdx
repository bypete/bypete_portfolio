...
<p class="text-fl-step-1">Originally created to promote the discography of **Jeff Wayne's Musical Version of The War of the Worlds**, the site quickly evolved to become the primary resource for explaining the story, connecting with fans, and introducing new listeners to the TWOTW experience.</p>
...
<div class="relative grid text-center leading-snug grid-cols-1 md:grid-cols-3 py-fl-space-3xl gap-fl-space-m text-teal-500 content-center max-w-container mx-auto">
  <p><span class="block text-fl-step-6 font-black"><Icon name="lucide:message-circle-heart" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="Users" />20K</span> Users</p>
  <p><span class="block text-fl-step-6 font-black"><Icon name="lucide:message-square-text" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="Message boards" />19</span> Message boards</p>
  <p><span class="block text-fl-step-6 font-black"><Icon name="lucide:messages-square" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="Topics" />3.2K</span> Topics</p>
</div>
</Block>
...
<InlineBento collections="twotw.old" >
<Fragment slot='title'>
## Original site
</Fragment>
</InlineBento>

<InlineBento collections="twotw" >
<Fragment slot='title'>
## Reworked visuals
</Fragment>

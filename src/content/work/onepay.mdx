...
product:
  src: './onepay/product.png'
  alt: 'Laptop and iPhone image showing Onepay website'
cover:
  src: './onepay/cover.jpg'
  alt: 'OnePay logo'
  credit: 'OnePay'
splash:
  src: './onepay/laptop_iphone_front.jpg'
  alt: 'Laptop and iPhone image showing Onepay website'
  credit: 'OnePay'
skillset:
  text: 'text-white'
...
import data from '~/data/work/onepay.data.json'
...
<InlineBento gallerySlug="onepay" >
<Fragment slot='title'>
## Customer views
</Fragment>
</InlineBento>

<InlineBento gallerySlug="onepay.agency" >
<Fragment slot='title'>
## Agency views
</Fragment>
</InlineBento>

<InlineBento gallerySlug="onepay.cs" >
<Fragment slot='title'>
...
<InlineBento gallerySlug="onepay.email" >
<Fragment slot='title'>
## Email templates
</Fragment>

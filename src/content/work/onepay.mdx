...
brand: 
  ...
  color: 'text-[#00a3e2]'
cover:
  url: '../../assets/work/onepay/listing.jpg'
  alt: 'OnePay logo'
  credit: 'OnePay'
skillset:
  text: 'text-white'
  ...
  areas:
    ...
    - title: 'My responsibilities'
      ...
      skills:
          ...
          - 'Asset preparation'
          - 'UX/UI'
tags: ['featured', 'responsive', 'fintech']
---
...
import laptop_iphone_front from '../../assets/work/onepay/laptop_iphone_front.jpg';
...
<BlockPicture src={laptop_iphone_front} class="my-0" alt="Laptop and iPhone image showing Onepay website" credit={frontmatter.title} wrapper={true} />

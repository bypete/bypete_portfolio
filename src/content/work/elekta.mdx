...
<p class="text-fl-step-1">Elekta is a forward-thinking Swedish healthcare company that provides precision radiation therapy solutions. They asked Fifth Dimension to improve their current intranet solution, Elekta.biz.</p>
...
<InlineBento collections="elekta" >
<Fragment slot='title'>
## Site visuals | Sales
</Fragment>
</InlineBento>

<InlineBento collections="elekta.service" >
<Fragment slot='title'>
...
<cite class="text-fl-step-0">Andrew Rodgers, Global Web & Multimedia Manager</cite>

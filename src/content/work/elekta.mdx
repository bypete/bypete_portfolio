...
<BlockPicture src={tablet} class="my-0" alt="iPad image showing Elekta website" credit={frontmatter.title} wrapper={true} />
...
<cite class="text-base text-gray-700 font-medium">**Andrew Rodgers, Global Web & Multimedia Manager**</cite>
...
<p class="note text-base">Client quotes and performance metrics originally published at fifthdimension.com</p>

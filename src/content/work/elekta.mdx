...
product:
  src: './elekta/product.png'
  alt: 'iPad image showing Elekta website'
cover:
  src: './elekta/cover.jpg'
  alt: 'Elekta logo'
  credit: 'Elekta'
splash:
  src: './elekta/tablet.jpg'
  alt: 'iPad image showing Elekta website'
  credit: 'Elekta'
skillset:
  text: 'text-white'
...
import tablet from './elekta/tablet.jpg';
...
<InlineBento gallerySlug="elekta" >
<Fragment slot='title'>
## Site visuals | Sales
</Fragment>
</InlineBento>

<InlineBento gallerySlug="elekta.service" >
<Fragment slot='title'>

...
<Figure caption='Example of the index listing and template pages ' credit={frontmatter.title}>
  <Image src={listing_1} alt="Listing page" class="w-full h-auto shadow-md border border-outline" />
  <Image src={listing_2} alt="Homepage" class="w-full h-auto shadow-md border border-outline" />
  <Image src={listing_3} alt="Article" class="w-full h-auto shadow-md border border-outline" />
</Figure>

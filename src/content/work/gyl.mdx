...
<div class="relative grid grid-cols-2 md:grid-cols-4 py-16 md:py-32 xl:py-48 gap-8 content-center max-w-container mx-auto">
  <p class="text-center leading-snug"><span class="block text-fl-step-6 text-[#24a7be] font-black"><Icon name="fa6-brands:youtube" class="w-12 h-12 mx-auto block" alt="youtube" />6.44K</span> Youtube subscribers</p>
  <p class="text-center leading-snug"><span class="block text-fl-step-6 text-[#24a7be] font-black"><Icon name="fa6-brands:instagram" class="w-12 h-12 mx-auto block" alt="instagram" />61.3K</span> Instagram followers</p>
  <p class="text-center leading-snug"><span class="block text-fl-step-6 text-[#24a7be] font-black"><Icon name="fa6-brands:x-twitter" class="w-12 h-12 mx-auto block" alt="x-twitter" />99.7K</span> X Followers</p>
  <p class="text-center leading-snug"><span class="block text-fl-step-6 text-[#24a7be] font-black"><Icon name="fa6-brands:facebook" class="w-12 h-12 mx-auto block" alt="facebook" />52K</span> Facebook Followers</p>
</div>
</Block>

...
<Block
    ...
    wrapperClass="bg-sky-400 not-prose my-fl-space-2xl"
    class="py-fl-space-3xl text-center"
...
>
    ...
    <p slot="s1" class="text-fl-step-5/tight font-black"><Icon name="fa6-brands:youtube" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="youtube" />6.44K <span class="text-fl-step--1 block font-medium">Youtube subscribers</span></p>
    <p slot="s2" class="text-fl-step-5/tight font-black"><Icon name="fa6-brands:instagram" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="instagram" />61.3K <span class="text-fl-step--1 block font-medium">Instagram followers</span></p>
    <p slot="s3" class="text-fl-step-5/tight font-black"><Icon name="fa6-brands:x-twitter" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="x-twitter" />99.7K <span class="text-fl-step--1 block font-medium">X Followers</span></p>
    <p slot="s4" class="text-fl-step-5/tight font-black"><Icon name="fa6-brands:facebook" class="w-fl-space-xl-2xl h-fl-space-xl-2xl mx-auto block" title="facebook" />52K <span class="text-fl-step--1 block font-medium">Facebook Followers</span></p>
</Block>

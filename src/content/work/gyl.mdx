...
<BlockPicture src={laptop_iphone_front} class="my-0" alt="Laptop and iPhone image showing GamesYouLoved website" credit={frontmatter.title} wrapper={true} />
...
<p class="note text-base">Client quotes originally published at fifthdimension.com</p>
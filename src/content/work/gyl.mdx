...
<div class="relative grid text-center leading-snug grid-cols-2 md:grid-cols-4 py-fl-space-3xl gap-fl-space-m text-content-light content-center max-w-container mx-auto">
  <p><span class="block text-fl-step-6 font-black"><Icon name="fa6-brands:youtube" class="w-fl-space-xl-2xl h-auto mx-auto block" title="youtube" />6.44K</span> Youtube subscribers</p>
  <p><span class="block text-fl-step-6 font-black"><Icon name="fa6-brands:instagram" class="w-fl-space-xl-2xl h-auto mx-auto block" title="instagram" />61.3K</span> Instagram followers</p>
  <p><span class="block text-fl-step-6 font-black"><Icon name="fa6-brands:x-twitter" class="w-fl-space-xl-2xl h-auto mx-auto block" title="x-twitter" />99.7K</span> X Followers</p>
  <p><span class="block text-fl-step-6 font-black"><Icon name="fa6-brands:facebook" class="w-fl-space-xl-2xl h-auto mx-auto block" title="facebook" />52K</span> Facebook Followers</p>
</div>
</Block>

...
<Figure x-data="{compare: true}" grid={['flex flex-col md:flex-row items-center gap-8', utilities.tramline.all]} caption='Unnecessary elements from the online responsive version (left) were stripped out to streamline the app layout (middle and right)' credit={frontmatter.title}>

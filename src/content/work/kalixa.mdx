...
<p class="text-fl-step-1">Kalixa Pay was marketed as a cost-effective contactless prepaid Mastercard with exclusive travel benefits. The site had to sell the product to potential customers, deliver relevant content to existing customers, and give access to accounts in a secure PCI environment.</p>
...
<InlineBento collections="kalixa" >
<Fragment slot='title'>
## Layouts
</Fragment>
</InlineBento>

<InlineBento collections="kalixa.variations" >
<Fragment slot='title'>
## Campaign variations
</Fragment>
</InlineBento>

<InlineBento collections="kalixa.email" >
<Fragment slot='title'>
## Email campaigns
</Fragment>
</InlineBento>
